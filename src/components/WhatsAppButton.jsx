...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] p-3 text-white shadow-2xl shadow-navy-900/25 transition hover:scale-105 hover:bg-[#20bd5a] focus:outline-none focus:ring-4 focus:ring-[#25D366]/35 sm:bottom-6 sm:right-6 sm:h-16 sm:w-16 sm:p-3.5"
    >
